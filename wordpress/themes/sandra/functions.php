<?php
/**
 * Sandra functions and definitions
 * *
 * @package WordPress
 * @subpackage Sandra
 * @since 1.0.0
...
if ( ! function_exists( 'sandra_setup' ) ) :
	function sandra_setup(){

		load_theme_textdomain( 'sandra', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'sandra_setup' );
...
// function sandra_custom_header_setup() {
// 	$defaults = array(
// 		'default-image'         => false,
...
// 	);
// }
// add_action( 'after_setup_theme', 'sandra_custom_header_setup' );
...
// 	register_sidebar(
// 		array(
// 			'name'          => __( 'Footer', 'sandra' ),
// 			'id'            => 'footer-1',
// 			'description'   => __( 'Add widgets here to appear in your footer.', 'sandra' ),
...
//         'name'          => 'Header',
//         'id'            => 'header-1',
//         'description'   => __( 'Add Google Analytics script here.', 'sandra' ),
